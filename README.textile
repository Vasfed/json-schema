...
h2. Extensions to standard

Also this fork adds extended validation for 'valueDependencies' - validates against certain values of fields.
...
here presence of attribute 'status_a' is validated.
